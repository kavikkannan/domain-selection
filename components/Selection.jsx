                            ...
                            <div className="relative flex flex-col  items-center w-[80%] h-fit gap-10 sm:flex-row sm:items-start sm:h-full sm:justify-evenly ">
                                <motion.button
                                    ...
                                    className={
                                        nextClicked
                                            ? management
                                                ? 'bg-gray-300 font-bold text-black text-xl h-fit w-full z-0 transform rotate-y-3 transition-all duration-500 rounded-xl sm:h-full'
                                                : 'z-[-200000] transition-all delay-100 absolute hidden'
                                            : management
                                            ? 'bg-green-300 font-bold text-black text-xl h-fit w-1/2 z-10 shadow-green-400 shadow-md transform rotate-y-6 transition-all duration-500 rounded-3xl  sm:h-[75%]'
                                            : 'bg-gray-300 font-bold text-black text-xl h-fit w-1/2 z-0 transform rotate-y-3 transition-all duration-500 rounded-xl sm:w-1/4 sm:h-[75%]'
                                    }
                                >
                         ...
                         relative  flex justify-center items-center "
                                ...
                                <motion.button
                                    ...
                                    className={
                                        nextClicked
                                            ? technical
                                                ? 'bg-gray-300 font-bold text-black text-xl h-[75%] w-full z-0 transform rotate-y-3 transition-all duration-500 rounded-xl sm:h-full'
                                                : 'z-[-200000] transition-all delay-100 absolute hidden'
                                            : technical
                                            ? 'bg-green-300 font-bold text-black text-xl h-fit w-1/2 z-10 shadow-green-400 shadow-md transform rotate-y-6 transition-all duration-500 rounded-3xl  sm:h-[75%]'
                                            : 'bg-gray-300 font-bold text-black text-xl h-fit w-1/2 z-0 transform rotate-y-3 transition-all duration-500 rounded-xl sm:w-1/4 sm:h-[75%]'
